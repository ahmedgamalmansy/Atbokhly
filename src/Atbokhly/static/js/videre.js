...
//                    '<div class="vid-shadow-layer"></div>'+
                    ...
                    '<div class="vid-controls-bottom flex align-center justify-center">'+
                        '<div class="vid-controls-wrapper">'+
                            '<div class="vid-controls-contents flex align-center justify-center">'+
                                '<button class="vid-play-btn item"><i class="flex align-center fa fa-play"></i></button>'+
                                ...
                                '<button class="vid-request-fullscreen item">full<i class="ion-android-expand flex align-center"></i></button>'+
                            '</div>'+
                        '</div>'+
                    '</div>'+
		...
		decodeMedia : function (el) {
			...
			media.onended = function() {
				...
				$('.vid-play-btn').find('i').addClass('fa-play').removeClass('fa-pause');
			};
		...
		togglePlay : function() {
			...
			if (!isPlaying){
				...
				$('.vid-play-btn').find('i').removeClass('fa-play').addClass('fa-pause');
			} else {
